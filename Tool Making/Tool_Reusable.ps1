function Get-SystemInfo {
    ...
    #>
    param( # Pass information into the scope or function
    ...
    Write-Output $obj # Pass information out of the scope into the pipeline.
}

Get-SystemInfo -ComputerName ILCSDC0
